...
from .views import question_list, list_info ,change_profile ,question_details, register, create_question,update_question, delete_question, update_answer, delete_answer
urlpatterns = [
